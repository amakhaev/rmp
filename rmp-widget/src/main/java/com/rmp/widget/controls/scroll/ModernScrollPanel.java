package com.rmp.widget.controls.scroll;
...
/**
 * Provides the modern scroll pane
 */
public class ModernScrollPanel extends JScrollPane {
    ...
    public ModernScrollPanel(Component view) {
        this(view, VERTICAL_SCROLLBAR_AS_NEEDED, HORIZONTAL_SCROLLBAR_AS_NEEDED);
    }

    public ModernScrollPanel(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy);
    }

    public ModernScrollPanel(Component view, int vsbPolicy, int hsbPolicy) {
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        public ModernScrollBarUI(ModernScrollPanel sp) {
            this.sp = sp;
        }
    ...
    public static void main(String[] args) {
        ...
        frame.add(new ModernScrollPanel(content));
